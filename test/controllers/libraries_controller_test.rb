...
class LibrariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create library" do
    assert_difference('Library.count') do
      post libraries_url, params: { library: { fine: @library.fine, location: @library.location, name: @library.name, timestamp: @library.timestamp } }
    end
  ...
  test "should update library" do
    patch library_url(@library), params: { library: { fine: @library.fine, location: @library.location, name: @library.name, timestamp: @library.timestamp } }
